    ...
    public var tasks: [String] {
        ...
        case .room:
            return [
                ...
                "옷 정리", "조명/스위치 닦기", "커튼 정리",
                "창문/유리창 닦기", "전자기기 정리"
            ]
        case .bathroom:
            return [
                "변기 청소", "세면대 청소", "샤워부스 청소", "욕실 바닥 청소",
                "거울 닦기", "배수구 머리카락 제거", "욕실 매트 세탁",
                "수건 정리/교체", "칫솔꽂이 청소", "환풍기 청소"
            ]
        case .kitchen:
            return [
        ...
        case .laundry:
            return [
                "세탁기 돌리기", "건조기 사용", "옷 개기 및 정리",
                "속옷/양말 분류", "세탁물 분리", "다림질",
                "수건/이불 세탁", "세탁기 필터 청소", "세제 보충",
                "세탁 스케줄 확인"
            ]
        case .etc:
            return [
                "분리수거", "청소기 관리",
                "실내 식물 물주기", "애완동물 밥주기","애완동물 배변정리",
                "정기 소독 교체", "택배 정리", "공기청정기 청소",
