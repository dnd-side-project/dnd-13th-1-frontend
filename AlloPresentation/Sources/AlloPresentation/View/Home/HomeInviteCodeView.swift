...
public struct HomeInviteCodeView: View {
    @StateObject var viewModel: HomeInviteCodeViewModel
    
    public init(viewModel: HomeInviteCodeViewModel) {
