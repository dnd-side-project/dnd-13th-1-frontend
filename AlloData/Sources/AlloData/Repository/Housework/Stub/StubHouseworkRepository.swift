...
public struct StubHouseworkRepository: HouseworkRepository {
    ...
    private let houseworks: [Housework] = {
        ...
        return [
            ...
            Housework(id: 16, place: "주방", title: "설거지", member: [Member(id: 1, name: "김철수", profileImageUrl: URL(string: "https://randomuser.me/api/portraits/men/50.jpg")!)], date: today, isDone: false, routine: .everyday),
            ...
            Housework(id: 24, place: "베란다", title: "창문 닦기", member: [Member(id: 1, name: "김철수", profileImageUrl: URL(string: "https://randomuser.me/api/portraits/men/1.jpg")!), Member(id: 3, name: "박민수", profileImageUrl: URL(string: "https://randomuser.me/api/portraits/men/45.jpg")!)], date: tomorrow, isDone: false, routine: .everyMonth),
